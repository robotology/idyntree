...
* It contains support for **reading and writing URDF files** and **reading SDFormat files** from a `iDynTree::Model`, making it useful to work with robot models from various sources including ROS and Gazebo. This is done as iDynTree was meant to develop **tools for identification of kinematics and dynamics parameters**.
