classdef DynamicsRegressorParameter < SwigRef
  methods
    function varargout = category(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMATLAB_wrap(733, self);
      else
        nargoutchk(0, 0)
        iDynTreeMATLAB_wrap(734, self, varargin{1});
      end
    end
    function varargout = elemIndex(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMATLAB_wrap(735, self);
      else
        nargoutchk(0, 0)
        iDynTreeMATLAB_wrap(736, self, varargin{1});
      end
    end
    function varargout = type(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMATLAB_wrap(737, self);
      else
        nargoutchk(0, 0)
        iDynTreeMATLAB_wrap(738, self, varargin{1});
      end
    end
    ...
    function self = DynamicsRegressorParameter(varargin)
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(742, varargin{:});
        tmp = iDynTreeMATLAB_wrap(742, varargin{:}); % FIXME
