  ...
  methods
    ...
    function self = DynamicsRegressorParameter(varargin)
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigCPtr = iDynTreeMATLAB_wrap(271,'new_DynamicsRegressorParameter',varargin{:});
        %self.swigOwn = true;
        tmp = iDynTreeMATLAB_wrap(271,'new_DynamicsRegressorParameter',varargin{:}); % FIXME
    ...
    function delete(self)
      if self.swigOwn
        iDynTreeMATLAB_wrap(272,'delete_DynamicsRegressorParameter',self);
        self.swigOwn=false;
      end
    end
    function [v,ok] = swig_fieldsref(self,i)
      ...
      switch i
        ...
        case 'elemIndex'
          ...
          return
        case 'type'
          v = iDynTreeMATLAB_wrap(267,'DynamicsRegressorParameter_type_get',self);
          ok = true;
          return
      end
    end
    function [self,ok] = swig_fieldasgn(self,i,v)
      switch i
        ...
        case 'elemIndex'
          ...
          return
        case 'type'
          iDynTreeMATLAB_wrap(268,'DynamicsRegressorParameter_type_set',self,v);
          ok = true;
          return
      end
    end
