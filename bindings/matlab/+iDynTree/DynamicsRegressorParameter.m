classdef DynamicsRegressorParameter < SwigRef
  methods
    ...
    function varargout = category(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(975, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(976, self, varargin{1});
      end
    end
    function varargout = elemIndex(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(977, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(978, self, varargin{1});
      end
    end
    function varargout = type(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(979, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(980, self, varargin{1});
      end
    end
