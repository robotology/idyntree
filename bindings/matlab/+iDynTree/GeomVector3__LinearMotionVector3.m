classdef GeomVector3__LinearMotionVector3 < iDynTree.Vector3
  methods
    function varargout = semantics(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMATLAB_wrap(272, self);
      else
        nargoutchk(0, 0)
        iDynTreeMATLAB_wrap(273, self, varargin{1});
      end
    end
    ...
    function varargout = setSemantics(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(276, self, varargin{:});
    end
    ...
    function varargout = plus(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(281, self, varargin{:});
    end
