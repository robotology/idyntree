classdef MovableJointImpl5 < iDynTree.IJoint
  methods
    ...
    function varargout = setIndex(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(661, self, varargin{:});
    end
    ...
    function varargout = setPosCoordsOffset(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(663, self, varargin{:});
    end
    ...
    function varargout = setDOFsOffset(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(665, self, varargin{:});
    end
