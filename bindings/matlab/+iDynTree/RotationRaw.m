classdef RotationRaw < iDynTree.Matrix3x3
  methods
    ...
    function varargout = changeCoordFrameOf(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(280, self, varargin{:});
    end
  ...
  methods(Static)
    ...
    function varargout = RotX(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(281, varargin{:});
    end
    ...
    function varargout = RPY(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(284, varargin{:});
    end
