classdef GeomVector3Semantics__LinearForceVector3Semantics < SwigRef
  methods
    ...
    function varargout = setToUnknown(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(198, self, varargin{:});
    end
    ...
    function varargout = dot(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(206, self, varargin{:});
    end
  ...
  methods(Static)
    function varargout = compose(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(204, varargin{:});
    end
