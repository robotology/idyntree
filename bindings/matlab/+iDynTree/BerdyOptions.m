classdef BerdyOptions < SwigRef
  methods
    ...
    function varargout = jointOnWhichTheInternalWrenchIsMeasured(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1318, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1319, self, varargin{1});
      end
    end
    function varargout = baseLink(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1320, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1321, self, varargin{1});
      end
    end
