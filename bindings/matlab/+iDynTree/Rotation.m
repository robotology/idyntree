classdef Rotation < iDynTree.RotationRaw
  ...
  methods(Static)
    ...
    function varargout = RotX(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(318, varargin{:});
    end
    function varargout = RotY(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(319, varargin{:});
    end
    function varargout = RotZ(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(320, varargin{:});
    end
    function varargout = RotAxis(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(321, varargin{:});
    end
