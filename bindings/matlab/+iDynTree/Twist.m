  ...
  methods
    function self = Twist(varargin)
      ...
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(215, varargin{:});
        tmp = iDynTreeMATLAB_wrap(215, varargin{:}); % FIXME
    ...
    function varargout = minus(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(218, self, varargin{:});
    end
