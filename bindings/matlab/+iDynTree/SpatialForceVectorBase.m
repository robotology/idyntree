  ...
  methods
    function self = SpatialForceVectorBase(varargin)
      ...
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(352, varargin{:});
        tmp = iDynTreeMATLAB_wrap(352, varargin{:}); % FIXME
    ...
    function delete(self)
      if self.swigInd
        iDynTreeMATLAB_wrap(353, self);
        self.swigInd=uint64(0);
      end
    end
    function varargout = getLinearVec3(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(354, self, varargin{:});
    end
    function varargout = getAngularVec3(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(355, self, varargin{:});
    end
    function varargout = setLinearVec3(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(356, self, varargin{:});
    end
    function varargout = setAngularVec3(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(357, self, varargin{:});
    end
    function varargout = paren(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(358, self, varargin{:});
    end
    function varargout = getVal(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(359, self, varargin{:});
    end
    function varargout = setVal(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(360, self, varargin{:});
    end
    function varargout = size(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(361, self, varargin{:});
    end
    function varargout = zero(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(362, self, varargin{:});
    end
    ...
    function varargout = fromMatlab(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(376, self, varargin{:});
    end
  end
  methods(Static)
    function varargout = compose(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(365, varargin{:});
    end
    function varargout = inverse(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(366, varargin{:});
    end
    function varargout = Zero(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(371, varargin{:});
    end
  end
end
