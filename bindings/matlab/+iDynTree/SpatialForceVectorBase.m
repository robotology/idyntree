classdef SpatialForceVectorBase < iDynTree.IVector
  methods
    ...
    function varargout = setLinearVec3(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(355, self, varargin{:});
    end
    ...
    function varargout = zero(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(361, self, varargin{:});
    end
  ...
  methods(Static)
    function varargout = compose(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(364, varargin{:});
    end
    function varargout = inverse(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(365, varargin{:});
    end
    function varargout = Zero(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(370, varargin{:});
    end
  end
end
