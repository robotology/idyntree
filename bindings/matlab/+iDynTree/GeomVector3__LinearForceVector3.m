classdef GeomVector3__LinearForceVector3 < iDynTree.Vector3
  methods
    function varargout = semantics(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMATLAB_wrap(252, self);
      else
        nargoutchk(0, 0)
        iDynTreeMATLAB_wrap(253, self, varargin{1});
      end
    end
    ...
    function varargout = setSemantics(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(256, self, varargin{:});
    end
    function varargout = changeCoordFrame(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(257, self, varargin{:});
    end
    function varargout = dot(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(260, self, varargin{:});
    end
  ...
  methods(Static)
    function varargout = compose(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(258, varargin{:});
    end
