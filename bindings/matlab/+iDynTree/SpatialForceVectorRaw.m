classdef SpatialForceVectorRaw < iDynTree.Vector6
  methods
    function self = SpatialForceVectorRaw(varargin)
      ...
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(184, varargin{:});
        tmp = iDynTreeMATLAB_wrap(184, varargin{:}); % FIXME
  ...
  methods(Static)
    function varargout = compose(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(188, varargin{:});
    end
    function varargout = inverse(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(189, varargin{:});
    end
    function varargout = Zero(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(191, varargin{:});
    end
  end
end
