  ...
  methods
    function self = DynamicsComputations(varargin)
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(826, varargin{:});
        tmp = iDynTreeMATLAB_wrap(826, varargin{:}); % FIXME
    ...
    function varargout = getModelDynamicsParameters(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(855, self, varargin{:});
    end
  end
  methods(Static)
  end
