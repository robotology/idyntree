classdef SolidShape < SwigRef
  methods
    ...
    function varargout = name(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1013, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1014, self, varargin{1});
      end
    end
    function varargout = link_H_geometry(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1015, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1016, self, varargin{1});
      end
    end
    function varargout = material(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1017, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1018, self, varargin{1});
      end
    end
