  ...
  methods
    function self = Direction(varargin)
      ...
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(452, varargin{:});
        tmp = iDynTreeMATLAB_wrap(452, varargin{:}); % FIXME
    ...
    function delete(self)
      if self.swigInd
        iDynTreeMATLAB_wrap(453, self);
        self.swigInd=uint64(0);
      end
    end
    function varargout = Normalize(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(454, self, varargin{:});
    end
