classdef Box < iDynTree.SolidShape
  methods
    ...
    function varargout = x(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(913, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(914, self, varargin{1});
      end
    end
    function varargout = y(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(915, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(916, self, varargin{1});
      end
    end
    function varargout = z(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(917, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(918, self, varargin{1});
      end
    end
