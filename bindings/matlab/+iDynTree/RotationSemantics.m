classdef RotationSemantics < SwigRef
  methods
    ...
    function varargout = setOrientationFrame(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(501, self, varargin{:});
    end
    function varargout = setBody(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(502, self, varargin{:});
    end
    ...
    function varargout = setRefBody(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(504, self, varargin{:});
    end
    function varargout = setCoordinateFrame(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(505, self, varargin{:});
    end
  ...
  methods(Static)
    ...
    function varargout = inverse2(varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(510, varargin{:});
    end
  end
end
