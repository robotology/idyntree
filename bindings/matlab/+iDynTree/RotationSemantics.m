classdef RotationSemantics < SwigRef
  methods
    ...
    function varargout = setToUnknown(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(471, self, varargin{:});
    end
    ...
    function varargout = setOrientationFrame(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(477, self, varargin{:});
    end
    function varargout = setBody(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(478, self, varargin{:});
    end
