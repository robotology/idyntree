  ...
  methods
    function self = Axis(varargin)
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(413, varargin{:});
        tmp = iDynTreeMATLAB_wrap(413, varargin{:}); % FIXME
    ...
    function varargout = setOrigin(self,varargin)
      [varargout{1:nargout}] = iDynTreeMATLAB_wrap(418, self, varargin{:});
    end
