  ...
  methods
    function self = SpatialMotionVectorSemanticsBase(varargin)
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigInd = iDynTreeMATLAB_wrap(317, varargin{:});
        tmp = iDynTreeMATLAB_wrap(317, varargin{:}); % FIXME
    ...
    function varargout = display(self,varargin)
      [varargout{1:max(1,nargout)}] = iDynTreeMATLAB_wrap(321, self, varargin{:});
    end
  end
  methods(Static)
  end
