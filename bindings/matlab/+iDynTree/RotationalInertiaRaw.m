  ...
  methods
    function self = RotationalInertiaRaw(varargin)
      ...
      if nargin~=1 || ~ischar(varargin{1}) || ~strcmp(varargin{1},'_swigCreate')
        ...
        %self.swigCPtr = iDynTreeMATLAB_wrap(230,'new_RotationalInertiaRaw',varargin{:});
        %self.swigOwn = true;
        tmp = iDynTreeMATLAB_wrap(230,'new_RotationalInertiaRaw',varargin{:}); % FIXME
    ...
    function delete(self)
      if self.swigOwn
        iDynTreeMATLAB_wrap(231,'delete_RotationalInertiaRaw',self);
        self.swigOwn=false;
      end
    end
