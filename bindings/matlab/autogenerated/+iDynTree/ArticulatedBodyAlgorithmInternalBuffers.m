classdef ArticulatedBodyAlgorithmInternalBuffers < SwigRef
  methods
    ...
    function varargout = u(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1191, self);
      else
        nargoutchk(0, 0)
    ...
    function varargout = linksVel(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1193, self);
      else
        nargoutchk(0, 0)
    ...
    function varargout = linksBiasAcceleration(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1195, self);
      else
        nargoutchk(0, 0)
    ...
    function varargout = linksAccelerations(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1197, self);
      else
        nargoutchk(0, 0)
    ...
    function varargout = linkABIs(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1199, self);
      else
        nargoutchk(0, 0)
    ...
    function varargout = linksBiasWrench(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1201, self);
      else
        nargoutchk(0, 0)
