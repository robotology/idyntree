classdef Cylinder < iDynTree.SolidShape
  methods
    ...
    function varargout = length(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1049, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1050, self, varargin{1});
      end
    end
    function varargout = radius(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1051, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1052, self, varargin{1});
      end
    end
