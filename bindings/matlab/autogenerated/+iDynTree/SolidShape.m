classdef SolidShape < SwigRef
  methods
    ...
    function varargout = name(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1019, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1020, self, varargin{1});
      end
    end
    function varargout = link_H_geometry(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1021, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1022, self, varargin{1});
      end
    end
    function varargout = material(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1023, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1024, self, varargin{1});
      end
    end
