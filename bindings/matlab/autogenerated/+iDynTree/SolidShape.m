classdef SolidShape < SwigRef
  methods
    ...
    function varargout = name(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(968, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(969, self, varargin{1});
      end
    end
    function varargout = nameIsValid(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(970, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(971, self, varargin{1});
      end
    end
    function varargout = link_H_geometry(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(972, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(973, self, varargin{1});
      end
    end
