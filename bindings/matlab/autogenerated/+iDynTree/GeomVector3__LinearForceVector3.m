classdef GeomVector3__LinearForceVector3 < iDynTree.Vector3
  methods
    function varargout = semantics(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(455, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(456, self, varargin{1});
      end
    end
  ...
  methods(Static)
    ...
    function varargout = inverse(varargin)
     [varargout{1:nargout}] = iDynTreeMEX(461, varargin{:});
    end
  end
end
