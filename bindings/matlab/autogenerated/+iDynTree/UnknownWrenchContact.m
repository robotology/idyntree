classdef UnknownWrenchContact < SwigRef
  methods
    ...
    function varargout = unknownType(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1345, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1346, self, varargin{1});
      end
    end
    function varargout = contactPoint(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1347, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1348, self, varargin{1});
      end
    end
    function varargout = forceDirection(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1349, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1350, self, varargin{1});
      end
    end
    function varargout = knownWrench(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1351, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1352, self, varargin{1});
      end
    end
