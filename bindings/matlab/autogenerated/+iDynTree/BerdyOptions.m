classdef BerdyOptions < SwigRef
  methods
    ...
    function varargout = includeAllNetExternalWrenchesAsDynamicVariables(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1490, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1491, self, varargin{1});
      end
    end
    function varargout = includeAllJointAccelerationsAsSensors(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1492, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1493, self, varargin{1});
      end
    end
