classdef ColorViz < SwigRef
  methods
    ...
    function varargout = r(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1874, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1875, self, varargin{1});
      end
    end
    ...
    function varargout = a(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1880, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1881, self, varargin{1});
      end
    end
