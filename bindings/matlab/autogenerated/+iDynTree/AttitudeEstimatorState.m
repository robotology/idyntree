classdef AttitudeEstimatorState < SwigRef
  methods
    ...
    function varargout = m_angular_velocity(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1649, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1650, self, varargin{1});
      end
    end
    function varargout = m_gyroscope_bias(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1651, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1652, self, varargin{1});
      end
    end
