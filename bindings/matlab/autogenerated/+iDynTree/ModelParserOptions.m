classdef ModelParserOptions < SwigRef
  methods
    ...
    function varargout = addSensorFramesAsAdditionalFrames(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1457, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1458, self, varargin{1});
      end
    end
    function varargout = originalFilename(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1459, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1460, self, varargin{1});
      end
    end
