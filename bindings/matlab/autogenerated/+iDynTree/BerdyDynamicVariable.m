classdef BerdyDynamicVariable < iDynTreeSwigRef
  methods
    ...
    function varargout = id(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1622, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1623, self, varargin{1});
      end
    end
    function varargout = range(self, varargin)
      ...
      if nargin==1
        nargoutchk(0, 1)
        varargout{1} = iDynTreeMEX(1624, self);
      else
        nargoutchk(0, 0)
        iDynTreeMEX(1625, self, varargin{1});
      end
    end
