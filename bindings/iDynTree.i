...
% include "std_string.i" % include "std_unordered_map.i" % include "std_vector.i"
...
% include "iDynTree/Utils.h"
    ...
    /* Note : always include headers following the inheritance order */
    // Basic math classes
    % include "iDynTree/MatrixDynSize.h" % include "iDynTree/MatrixFixSize.h"
    % include "iDynTree/SparseMatrix.h"
...
% include "iDynTree/VectorDynSize.h" % include "iDynTree/VectorFixSize.h"
...
% include "iDynTree/SpatialMotionVector.h" % include "iDynTree/SpatialForceVector.h"
    % include "iDynTree/Twist.h" % include "iDynTree/Wrench.h"
    % include "iDynTree/SpatialMomentum.h" % include "iDynTree/SpatialAcc.h"
    % include "iDynTree/ClassicalAcc.h" % include "iDynTree/Direction.h"
    % include "iDynTree/Axis.h"

    // Inertias
    % include "iDynTree/RotationalInertia.h" % include "iDynTree/SpatialInertia.h"
    % include "iDynTree/ArticulatedBodyInertia.h"
    % include "iDynTree/InertiaNonLinearParametrization.h"

    // Transformations: Rotation and Transform
    % include "iDynTree/Rotation.h" % include "iDynTree/Transform.h"
    % include "iDynTree/TransformDerivative.h" % include "iDynTree/Span.h"
...
// Model related data structures
% include "iDynTree/Indices.h" % include "iDynTree/LinkState.h" % include "iDynTree/Link.h"
    % include "iDynTree/IJoint.h" % include "iDynTree/FixedJoint.h"
    % include "iDynTree/MovableJointImpl.h"
...
% include "iDynTree/RevoluteJoint.h" % include "iDynTree/SphericalJoint.h"
    % include "iDynTree/PrismaticJoint.h" % include "iDynTree/Traversal.h"
    % include "iDynTree/SolidShapes.h" % include "iDynTree/Sensors.h" % include "iDynTree/Model.h"
    % include "iDynTree/JointState.h" % include "iDynTree/FreeFloatingMatrices.h"
    % include "iDynTree/FreeFloatingState.h" % include "iDynTree/ContactWrench.h"
    % include "iDynTree/ModelTestUtils.h" % include "iDynTree/ModelTransformers.h"
    % include "iDynTree/SubModel.h" % include "iDynTree/SixAxisForceTorqueSensor.h"
    % include "iDynTree/AccelerometerSensor.h" % include "iDynTree/GyroscopeSensor.h"
    % include "iDynTree/ThreeAxisAngularAccelerometerSensor.h"
    % include "iDynTree/ThreeAxisForceTorqueContactSensor.h"
    % include "iDynTree/PredictSensorsMeasurements.h"

    % include "sensors.i" % include "joints.i"
...
// Kinematics & Dynamics related functions
% include "iDynTree/ForwardKinematics.h" % include "iDynTree/Dynamics.h"
    % include "iDynTree/DenavitHartenberg.h"

    // Model loading from external formats
    % include "iDynTree/URDFDofsImport.h" % include "iDynTree/ModelLoader.h"
    % include "iDynTree/ModelExporter.h"
    % include "iDynTree/ModelCalibrationHelper.h"
    ...
    % include "iDynTree/ExternalWrenchesEstimation.h"
    % include "iDynTree/ExtWrenchesAndJointTorquesEstimator.h"
    % include "iDynTree/SimpleLeggedOdometry.h" % include "iDynTree/BerdyHelper.h"
    % include "iDynTree/BerdySparseMAPSolver.h" % include "iDynTree/AttitudeEstimator.h"
    % include "iDynTree/AttitudeMahonyFilter.h" % include "iDynTree/ExtendedKalmanFilter.h"
    % include "iDynTree/AttitudeQuaternionEKF.h"
...
% include "iDynTree/Visualizer.h"
    ...
    // Inverse Kinematics
    % include "iDynTree/ConvexHullHelpers.h" % include "iDynTree/InverseKinematics.h"
