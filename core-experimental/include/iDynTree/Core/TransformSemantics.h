...
namespace iDynTree
{
    ...
    public:
        ...
        static bool check_apply(const TransformSemantics & op1, const PositionSemantics & op2);
        ...
        static PositionSemantics apply(const TransformSemantics & op1, const PositionSemantics & op2);
        static void apply(const TransformSemantics & op1, const PositionSemantics & op2, PositionSemantics & result);
