...
*/
    class TreeIdSerialSolver_RNE : public TreeIdSolver, public TreeSerialSolver {
    public:
        /**
...
*/
        TreeIdSerialSolver_RNE(const Tree& tree,Vector grav=Vector::Zero(),const TreeSerialization & serialization=TreeSerialization());
        
        TreeIdSerialSolver_RNE(const Tree& tree, const TreeSerialization & serialization);

        
        ~TreeIdSerialSolver_RNE(){};
