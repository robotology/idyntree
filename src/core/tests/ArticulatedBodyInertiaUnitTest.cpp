...
void checkInvariance(const Transform& trans,
                     const ArticulatedBodyInertia& inertia,
                     const SpatialAcc& twist)
{
...
int main()
{
    ...
    double rotInertiaData[3 * 3] = {10.0, 0.5, 0.8, 0.5, 20.0, 0.6, 0.8, 0.6, 25.0};
