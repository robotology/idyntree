...
int main()
{
    ...
    std::shared_ptr<LinearConstraint> controlConstraint(
        new LinearConstraint(1, "linearConstraint"));
    ...
    ASSERT_IS_TRUE(
        group->addConstraint(controlConstraint, iDynTree::optimalcontrol::TimeRange(0.6, 1.0)));
