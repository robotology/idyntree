...
public:
    ...
    virtual bool getConstraintsBounds(iDynTree::VectorDynSize& constraintsLowerBounds,
                                      iDynTree::VectorDynSize& constraintsUpperBounds) override
    {
    ...
    {
        costValue = m_a1 * m_variables(0) * m_variables(0) + m_b1 * m_variables(0)
                    + m_a2 * m_variables(1) * m_variables(1) + m_b2 * m_variables(1);
        return true;
    }
    ...
    virtual bool evaluateConstraintsHessian(const iDynTree::VectorDynSize& constraintsMultipliers,
