...
KDL::CoDyCo::TreePartition iCubTree::get_iCub_partition(const KDL::CoDyCo::TreeSerialization & icub_serialization,bool ft_feet)
{
    ...
    left_arm.addLink(icub_serialization.getLinkID("r_forearm_dh_frame_fixed_joint"));
    ...
    right_arm.addLink(icub_serialization.getLinkID("r_forearm_dh_frame_fixed_joint"));
