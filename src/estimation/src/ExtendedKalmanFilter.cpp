...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfInit()
{
    ...
    {
        iDynTree::reportError("DiscreteExtendedKalmanFilterHelper",
                              "init",
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfPredict()
{
    ...
    if (!m_initial_state_covariance_set)
    {
        iDynTree::reportError("DiscreteExtendedKalmanFilterHelper",
                              "ekfPredict",
                              "initial state covariance not set.");
        return false;
    }
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfUpdate()
{
    ...
    K = Phat * (H.transpose()) * (S.inverse()); ///< \f$ K_{k+1} = \hat{P}_{k+1} H_{k+1}^T
                                                ///< S_{k+1}^{-1} \f$
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfSetInitialState(
    const iDynTree::Span<double>& x0)
{
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfSetMeasurementVector(
    const iDynTree::Span<double>& y)
{
    if ((size_t)y.size() != m_dim_Y)
    {
        iDynTree::reportError("DiscreteExtendedKalmanFilterHelper",
                              "ekfSetMeasurementVector",
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfSetStateCovariance(
    const iDynTree::Span<double>& P)
{
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfSetSystemNoiseCovariance(
    const iDynTree::Span<double>& Q)
{
    if ((size_t)Q.size() != m_dim_X * m_dim_X)
    {
        iDynTree::reportError("DiscreteExtendedKalmanFilterHelper",
                              "setSystemNoiseMeanAndCovariance",
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfSetMeasurementNoiseCovariance(
    const iDynTree::Span<double>& R)
{
    if ((size_t)R.size() != m_dim_Y * m_dim_Y)
    {
        iDynTree::reportError("DiscreteExtendedKalmanFilterHelper",
                              "setMeasurementNoiseMeanAndCovariance",
                              "noise covariance matrix size mismatch");
        return false;
    }
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfGetStates(
    const iDynTree::Span<double>& x) const
{
...
bool iDynTree::DiscreteExtendedKalmanFilterHelper::ekfGetStateCovariance(
    const iDynTree::Span<double>& P) const
{
    if ((size_t)P.size() != m_P.capacity())
    {
        iDynTree::reportError("DiscreteExtendedKalmanFilterHelper",
                              "ekfGetStateCovariance",
                              "state covariance size mismatch");
        return false;
    }
