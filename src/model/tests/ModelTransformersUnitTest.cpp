...
void testConvertSphericalJointsToThreeRevoluteJoints()
{
    ...
    inertia.fromRotationalInertiaWrtCenterOfMass(1.0, Position::Zero(), RotationalInertia::Zero());
    ...
    Transform joint_H_child = Transform(Rotation::Identity(), Position(1.0, 0.0, 0.0));
    SphericalJoint sphericalJoint(joint_H_child);
    Position jointCenter(0.5, 0.0, 0.0);
    LinkIndex parentLinkIdx = originalModel.getLinkIndex("parent");
...
void testConvertThreeRevoluteJointsToSphericalJoint()
{
    ...
    parentInertia.fromRotationalInertiaWrtCenterOfMass(1.0, Position::Zero(), RotationalInertia::Zero());
    childInertia.fromRotationalInertiaWrtCenterOfMass(1.0, Position::Zero(), RotationalInertia::Zero());
    zeroInertia.zero();
    ...
    Position jointCenter(0.0, 0.0, 0.0);
...
void testRoundTripSphericalJointConversion()
{
    ...
    Transform joint_H_child = Transform::Identity();
    SphericalJoint sphericalJoint(joint_H_child);
