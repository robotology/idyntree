 ...
 *
 * bool ok = createReducedModelAndSensors(fullModel, fullSensors, jointsInReducedModel,
 * reducedModel, reducedSensors);
 *
 * // handle ok
 ...
 *
 */
IDYNTREE_DEPRECATED_WITH_MSG("createReducedModelAndSensors is deprecated, please use the "
                             "createReducedModel, see createReducedModelAndSensors documentation "
                             "for more info")
