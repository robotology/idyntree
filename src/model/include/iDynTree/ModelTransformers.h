 ...
 *
 * @deprecated This function signature with std::unordered_map<std::string, double>
 ...
 */
IDYNTREE_DEPRECATED_WITH_MSG("Use createReducedModel with std::unordered_map<std::string, std::vector<double>> for joints with multiple position coordinates")
bool createReducedModel(const Model& fullModel,
                        const std::vector<std::string>& jointsInReducedModel,
                        Model& reducedModel,
