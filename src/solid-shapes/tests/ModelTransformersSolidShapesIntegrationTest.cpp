...
void checkThatOneSphereIsApproximatedToABox()
{
    ...
    options.conversionType = ApproximateSolidShapesWithPrimitiveShapeConversionType::
    ...
    iDynTree::Box* oneBoxPtr
        = oneBoxModel.collisionSolidShapes().getLinkSolidShapes()[0][0]->asBox();
