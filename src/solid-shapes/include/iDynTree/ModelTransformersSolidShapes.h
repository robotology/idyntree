...
struct ApproximateSolidShapesWithPrimitiveShapeOptions
{
    ApproximateSolidShapesWithPrimitiveShapeConversionType conversionType
        = ApproximateSolidShapesWithPrimitiveShapeConversionType::
            ConvertSolidShapesWithEnclosingAxisAlignedBoundingBoxes;
 ...
 * shape of the model with its axis aligned bounding box, using the
 * iDynTree::computeBoundingBoxFromShape function.
 *
 */
