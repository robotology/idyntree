...
{
    return iCub::iKin::iKinLink(dhLink.A,
                                dhLink.D,
                                dhLink.Alpha,
                                dhLink.Offset,
                                dhLink.Min,
...
inline bool DHChainFromiKinChain(iCub::iKin::iKinChain& ikinChain, DHChain& dhChain)
{
...
inline bool iKinLimbFromDHChain(const DHChain& dhChain, iCub::iKin::iKinLimb& ikinLimb)
{
