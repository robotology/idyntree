...
void testConvexHullProjectionWithGravity()
{
    ...
    projectionConstraint.setProjectionAlongDirection(planeNormal, iDynTree::Position::Zero());
    ...
    projectionConstraint.setProjectionAlongDirection(skewedDirection, iDynTree::Position::Zero());
