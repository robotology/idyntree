/*
 * SPDX-FileCopyrightText: 2015-2021 Fondazione Istituto Italiano di Tecnologia (IIT)
...
int main()
{
    // Consistency test: load a URDF and a SDF that we know that match 
    // because the SDF was generated by converting the URDF, and check that they match
    return EXIT_SUCCESS;
}
