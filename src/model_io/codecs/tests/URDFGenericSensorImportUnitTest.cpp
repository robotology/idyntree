               ...
               unsigned int expectedNrOfFTs)
{
    ...
    std::cout << "Sensor list created from URDF. num accel : "
    ...
    ASSERT_EQUAL_DOUBLE(loader.sensors().getNrOfSensors(iDynTree::ACCELEROMETER),
                        expectedNrOfAccelerometers);
    ASSERT_EQUAL_DOUBLE(loader.sensors().getNrOfSensors(iDynTree::GYROSCOPE),
